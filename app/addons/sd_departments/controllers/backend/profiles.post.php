...
if ($mode === 'add_department' || $mode === 'update_department') {
    ...
    Tygh::$app['view']->assign([
        ...
        'u_info'  => !empty($department_data['head_id'])
            ? fn_get_user_short_info($department_data['head_id'])
            : [],
        'us_info'  => !empty($department_data['employee_id'])
            ? fn_get_user_short_info($department_data['employee_id'])
            : [],
    ]);
